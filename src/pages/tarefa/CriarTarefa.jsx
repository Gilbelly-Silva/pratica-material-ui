        ...
        <CardContent sx={{
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={1}>
                <Button size="small" variant="contained" onClick={handleSalvar} style={{backgroundColor: 'darkviolet'}}>Salvar</Button>
              </Grid>  
              <Grid item xs={1}>  
                <Button size="small" variant="outlined" onClick={handleClose} style={{borderColor: 'darkviolet', color: 'darkviolet'}}>Cancelar</Button>  
              </Grid>
            </Grid>  
          </Grid>
        </CardContent>
